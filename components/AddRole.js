...
export default function RoleForm({ onClose, onRoleAdded, roles }) {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || data.message || 'Failed to add role');
      }
        ...
        <form onSubmit={submit}>
          ...
          <div className="mb-4">
            ...
            >
              ...
              {roles.filter((role) => role.shareDataWithPeers === true).map((role) => (
